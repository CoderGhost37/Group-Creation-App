...
export async function createAdmin(name: string, email: string) {
  try {
...
<body>
  <div class="container">
    ...
    <div class="content">
      <p>Hello ${name},</p>
      <p>Your new Admin account on the Cinnavo app has been successfully created. Here are your login details:</p>
      <ul>
        <li>Email: ${email}</li>
